          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">
                {Number(data.healthMetrics?.overallHealthScore) || 0}%
              </div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600 mb-2">
                {formatCurrency(Number(data.healthMetrics?.revenuePerCustomer) || 0, currency)}
              </div>
            ...
            <div className="text-center">
              <div className={`text-3xl font-bold mb-2 ${
                (Number(data.healthMetrics?.growthMomentum) || 0) > 0
                  ? 'text-blue-600'
                  : 'text-red-600'
              }`}>
                {(Number(data.healthMetrics?.growthMomentum) || 0).toFixed(1)}%
              </div>
